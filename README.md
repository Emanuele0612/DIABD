...
L'esecuzione dell'applicazione Spark (contenuta nel notebook *Backend/create-recommendation.ipynb*) permette di popolare il database Neo4j con le raccomandazioni e le relazioni di similarità calcolate in modo permanente, per questo è sufficiente eseguirla solo al primo avvio del sistema.
